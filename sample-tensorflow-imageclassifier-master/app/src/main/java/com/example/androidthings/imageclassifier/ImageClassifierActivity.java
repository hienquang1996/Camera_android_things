...
public class ImageClassifierActivity extends Activity implements ImageReader.OnImageAvailableListener {
    ...
    private Handler mCameraStreamHandler = new Handler();
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mCameraStreamHandler.post(mCameraRunnable);
    ...
    private Runnable mCameraRunnable = new Runnable() {
        @Override
        public void run() {
            if(!standby) mCameraHandler.takePicture();
            mCameraStreamHandler.post(mCameraRunnable);
        }
    };
    ...
    /*public void onShutterClick(View view) {
        ...
        System.out.println("Received screen tap");
        startImageCapture();
    }*/
...
*/
    ...
    private void startImageCapture() {
        ...
        System.out.println("Ready for another capture? " + isReady);
        if (isReady) {
            setReady(false);
    ...
    public void onImageAvailable(ImageReader reader) {
       // if(takePicture) {
        ...
        System.out.println("Got the following results from Tensorflow: " + results);
